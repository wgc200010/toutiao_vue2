 <template>
  <div>
    ...
    <div class="article-container">
      ...
      <!-- 用户信息 -->
      <van-cell center :title="artObj.aut_name" :label="formData(artObj.pubdate
)">
        <template #icon>
        ...
        <template #default>
          <div>
            <van-button type="info" size="mini" v-if="artObj.is_followed
" @click="followedFn(false)">已关注</van-button>
      ...
      <!-- 点赞 -->
      <div class="like-box">
        <van-button icon="good-job" type="danger" size="small" v-if="artObj.attitude
===1" @click="loveFn(false)">已点赞</van-button>
